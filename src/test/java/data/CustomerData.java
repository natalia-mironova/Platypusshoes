...
public class CustomerData {
    ...
    public static int shippingPostcode = 3148;
    public static int customerPhone = 7775566;
    public static String  creditCardNumber = "4444333322221111";
    public static int creditCardDate = 1222;
