...
public class ProductListingPageTests extends BaseTest {
    ...
    @Test(description = "Test 1: User loads more products")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Test(description = "Test 2: User filters Product Listing Page")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Test(description = "Test 3: User applies sorting on the Product Listing Page")
